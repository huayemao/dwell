...
export default function ScenesPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md text-white overflow-y-auto pt-32 pb-24 px-8 z-40">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-light tracking-tighter mb-4">{t('scenes')}</h1>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-light mb-2">{t(scene.id as TranslationKey) || scene.name}</h3>
                  <p className="text-white/50 text-sm mb-8 min-h-[40px]">{scene.description}</p>
