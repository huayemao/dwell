...
export default function SoundsPage({ params }: { params: Promise<{ lang: string }> }) {
                  ...
                  {categories.map(cat => {
                    ...
                    return (
                      <option key={cat} value={cat} className="bg-black text-white">
                        {t(catKey) || cat.charAt(0).toUpperCase() + cat.slice(1)}
                      </option>
                    );
                  })}
                </select>
